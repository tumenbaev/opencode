...
export class Session2 extends HeyApiClient {
   ...
   */
  public trim<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
    ...
    return (options?.client ?? this.client).post<SessionTrimResponses, SessionTrimErrors, ThrowOnError>({
